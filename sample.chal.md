...
Today we're challenging you to write code to build a binary search tree. Tackle this classic computer 
...
Ever been frustrated with how a website was laid out?
###### **Use a Space API (B)**

Pick out any space themed API and utilize it in your hack.
 We want you to pick any website and imagine a new layout for it. You can simply draw it out, wireframe it, or even write the HTML/CSS if you'd like.
...
Ever feel bogged down with email? Check ou
...
Chatrooms are a great way to stay connected. You probably have several chats open right now! Today, we want you to learn how to build your own chatroom server using Linode! Check out this tutorial [[https://www.youtube.com/watch?v=GZdgjKRYQI8&ab_channel=Lin###### **Get Creative with Replit (B/ Open source)**
...
Share a project you built (old or new) using one of GitHub's student developer pack tools and post it to the GitHub Education Student Gallery.ode](https://www.youtube.com/watch?v=GZdgjKRYQI8&ab_channel=Linode) ] and submit your finished project
t some email APIs and see if there is anything you could streamline in your inbox.
