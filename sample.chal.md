...
###### **Make a weather tracking website with historical data with Velo and GitHub in EditorX**
...
**Play and Learn with TwiloQuest**
...
###### **Build & post a game on Replit using Kaboom.js**
...
You can do a ton with Autocode - build bots, APIs, web services and more!
...
###### **Add an interledger payment pointer to monetize one of your projects!**
...
###### **Build a Chatroom Server with JavaScript & Linode**
...
###### **Build a Linux Desktop in the Cloud!**
...
###### **Learn about web apps and webhooks.**
...
###### **Build a data science project with Replit**
...
###### **Share a project you built (old or new) using one of GitHub's student developer pack tools**
...
###### **Set up a CI/CD workflow in one of your existing projects!**

Signup for a free CircleCI account with GitHub and add a CI/CD workflow to one of your existing projects. Get started at [https://hackp.ac/ghwinit-circleci](https://hackp.ac/ghwinit-circleci).

###### **Make a phone ring with the internet!**
...
###### **Receiving text messages: Twilio**
...
Global Hack Week is in part powered by some helpful Discord bots. We'd love to see you create your own Discord/Slack Bot or any other chat bot you'd like.

###### **Build a web monetized application or website and share your experience with the Web Monetization community!**

Build a web monetized application or website and share your experience with the Web Monetization community! [[https://community.webmonetization.org/](https://community.webmonetization.org/)]
...
You might listen to music while hacking, but have you built anything for your music? Try building with a music API (Spotify's got great documentation)
...
Build a project to help manage schedules! Some ideas include developing this hack for your personal calendar, a professor's office hours, or a work schedule!
...
###### **Build a web monetized game!**

Build a web monetized game!
Don't forget to share your experience with the Web Monetization community!
[[https://community.webmonetization.org/](https://community.webmonetization.org/)] "
...
Knowing and understanding where your money goes is a great first step to being confident with your finances. Build a project to help you create or understand a budget
...
Have you ever used the Sendgrid email API? Use it and you'll be ready to automate sending emails.
...
Did you know how many Space APIs are out there? Pick out any space themed API and utilize it in your hack.
